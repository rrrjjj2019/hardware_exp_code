...
HD_PWD='D:/verilog/hardware_exp/lab1/By_JackGuo/3-bit_comperator/3-bit_comperator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparator_3bits_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comparator_3bits_t.tcl
