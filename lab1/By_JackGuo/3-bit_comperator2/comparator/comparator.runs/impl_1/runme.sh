...
HD_PWD='D:/verilog/hardware_exp/lab1/By_JackGuo/3-bit_comperator2/comparator/comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fanout.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fanout.tcl -notrace
