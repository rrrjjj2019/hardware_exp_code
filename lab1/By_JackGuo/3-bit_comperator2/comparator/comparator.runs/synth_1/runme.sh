...
HD_PWD='D:/verilog/hardware_exp/lab1/By_JackGuo/3-bit_comperator2/comparator/comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fanout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fanout.tcl
