...
HD_PWD='D:/verilog/hardware_exp/must_success_final_project/bluetooth_test/bluetooth_test/bluetooth_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulename.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulename.tcl -notrace
