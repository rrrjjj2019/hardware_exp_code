...
HD_PWD='D:/verilog/hardware_exp/must_success_final_project/bluetooth_test/bluetooth_test/bluetooth_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulename.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulename.tcl
